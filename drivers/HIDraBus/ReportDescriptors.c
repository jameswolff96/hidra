...
// Based on the actual Xbox 360 wireless controller descriptor
//
const UCHAR X360_HID_REPORT_DESCRIPTOR[] = {
...
const ULONG X360_HID_REPORT_DESCRIPTOR_SIZE = sizeof(X360_HID_REPORT_DESCRIPTOR);

//
// DualShock 4 Controller HID Report Descriptor (simplified version)
// Based on the PS4 controller descriptor but simplified for basic gamepad functionality
//
const UCHAR DS4_HID_REPORT_DESCRIPTOR[] = {
    0x05, 0x01,        // Usage Page (Generic Desktop Ctrls)
    0x09, 0x05,        // Usage (Game Pad)
    0xA1, 0x01,        // Collection (Application)
    0x85, 0x01,        //   Report ID (1)
...
const ULONG DS4_HID_REPORT_DESCRIPTOR_SIZE = sizeof(DS4_HID_REPORT_DESCRIPTOR);